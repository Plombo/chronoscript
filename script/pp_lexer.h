...
typedef enum PP_TOKEN_TYPE
{
    ...
    PP_TOKEN_CHAR_LITERAL, PP_TOKEN_STRING_LITERAL, PP_TOKEN_PTR_OP, PP_TOKEN_INC_OP,
    ...
    PP_TOKEN_AND_ASSIGN, PP_TOKEN_XOR_ASSIGN, PP_TOKEN_OR_ASSIGN, PP_TOKEN_ELLIPSIS,
    PP_TOKEN_IF, PP_TOKEN_ELSE, PP_TOKEN_SEMICOLON, PP_TOKEN_LCURLY, PP_TOKEN_RCURLY,
    ...
    PP_TOKEN_ERROR, PP_TOKEN_NEWLINE, PP_TOKEN_WHITESPACE, PP_TOKEN_DIRECTIVE,
    PP_TOKEN_CONCATENATE, PP_TOKEN_EOF, PP_EPSILON,
    PP_END_OF_TOKENS
} PP_TOKEN_TYPE;
